...
<head>
    ...
    <link rel="icon" href="../assets/img/logo/favicon.ico" type="image/gif" sizes="20x20">
    <title>Kabini River Lodge - Serene Wilderness Retreat</title>
    <meta name="description" content="Stay at Kabini River Lodge for a peaceful escape by the river. Enjoy wildlife safaris, lush landscapes, and comfortable accommodation. Book now.">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/kabini-river-lodge.php">
    <?php include('../include/inner/common-link.php'); ?>
</head>

<body>
    <?php include('../include/inner/header.php'); ?>

    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
            <div class="row">
                <div class="co-lg-12">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/kabini-resort-1.jpg" alt="Karnataka Tourism">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/kabini-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/kabini-resort-2.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/kabini-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/kabini-resort-3.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/kabini-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/kabini-resort-4.jpg" alt="Karnataka Tourism">
                                            <button class="StartSlideShowFirstImage"><i class="bi bi-plus-lg"></i> View More Images</button>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/kabini-resort-5.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/kabini-resort-10-v.mp4"><i class="bi bi-play-circle"></i> Watch Video</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img/resorts/kabini-resort-6.jpg" data-fancybox="images"><img src="../assets/img/resorts/kabini-resort-6.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/kabini-resort-7.jpg" data-fancybox="images"><img src="../assets/img/resorts/kabini-resort-7.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/kabini-resort-8.jpg" data-fancybox="images"><img src="../assets/img/resorts/kabini-resort-8.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/kabini-resort-9.jpg" data-fancybox="images"><img src="../assets/img/resorts/kabini-resort-9.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/kabini-resort-10.jpg" data-fancybox="images"><img src="../assets/img/resorts/kabini-resort-10.jpg" alt="Karnataka Tourism"></a>
            </div>
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    <h1 class="eco-head">Experience the Enchantment of Kabini River Lodge</h1>
                    ...
                    <h3 class="mb-2" style="color:#63ab45">Your Ultimate Retreat by the River</h3>
                    <p>Escape to Kabini River Lodge, where tranquillity meets adventure in the heart of southern India. Nestled along the pristine banks of the Kabini River, this lodge is your gateway to breathtaking landscapes and rich wildlife experiences. With stunning views and proximity to Nagarhole National Park, Kabini River Lodge is the perfect destination for those eager to explore or unwind in nature's embrace. Enjoy comfortable accommodations surrounded by lush greenery, making it an ideal haven for relaxation and excitement.</p>
                    <h3 class="mb-2" style="color:#63ab45">Unleash Your Inner Explorer</h3>
                    <p>At Kabini River Lodge, every day is an opportunity for exhilarating discovery. Engage in guided safaris through Nagarhole National Park, where you can witness majestic tigers, elusive leopards, gentle elephants, and many vibrant bird species. After an adventurous day, retreat to the riverside and bask in the serene atmosphere. Kabini River Lodge invites you to forge a deep connection with nature while indulging in our attentive team's genuine warmth and hospitality. Plan your visit today and step into the enchanting beauty of the Kabini wilderness.</p>
                ...
                <div class="col-xl-4">
                    <div class="contact-page">
                        ...
                        <div class="single-contact mb-40">
                            ...
                            <div class="content">
                                <h6><a href="tel:+919449244567">094492-44567</a></h6>
                            </div>
                        </div>
                        ...
                        <div class="single-contact mb-40">
                            ...
                            <div class="content">
                                <h6>
                                    ...
                                    HD Kote Taluk,<br>
                                    Karapura, Around Mysore - 571 114<br>
                                    Karnataka, India.
                                </h6>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 d-flex justify-content-center mt-0">
                    <a href="../book.php" class="primary-btn4 two" style="width:100%">
                ...
                <div class="col-xl-12">
                    <div class="room-details-area">
                        ...
                        <ul class="room-features">
                            <li>
                                <i class="fa-solid fa-wifi" style="color:#63ab45"></i>
                                Wifi
                            </li>
                            <li>
                                <i class="fa-solid fa-person-shelter" style="color:#63ab45"></i>
                                Living Room
                            </li>
                            <li>
                                <i class="fa-solid fa-couch" style="color:#63ab45"></i>
                                Seating Area
                            </li>
                            <li>
                                <i class="fa-solid fa-toilet" style="color:#63ab45"></i>
                                Private Bathroom
                            </li>
                            <li>
                                <i class="fa-solid fa-broom" style="color:#63ab45"></i>
                                Housekeeping
                            </li>
                            <li>
                                <i class="fa-solid fa-mug-hot" style="color:#63ab45"></i>
                                Coffee Maker
                            </li>
                            <li>
                                <i class="fa-solid fa-person-walking-luggage" style="color:#63ab45"></i>
                                Luggage Assiatance
                            </li>
                            <li>
                            ...
                            <li>
                                <i class="fa-solid fa-phone-volume" style="color:#63ab45"></i>
                                Wake-Up Call
                            </li>
                            <li>
                                <i class="fa-solid fa-car" style="color:#63ab45"></i>
                                Free Parking
                            </li>
                        </ul>
                    </div>
                    <div class="row">
                        <h4>Package Costing</h4>
                        <div class="col-lg-6 d-none d-lg-block" style="border: 1px solid #ddd"></div>
                        <div class="col-lg-6" style="border: 1px solid #ddd">
                            <h5 class="text-center py-1">Price in ₹ ( INR )</h5>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <h6 class="py-1 text-center">Accomodation</h6>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <h6 class="py-1 text-center">Weekday</h6>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <h6 class="py-1 text-center">Weekend</h6>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Tented [Tent Package]</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">12140.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">14280.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Room [Viceroy Package]</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">14050.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">16520.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Maharaja Cottage [Maharaja Package]</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">16000.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">18830.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Dormitory [Dormitory Package] *</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">8780.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">10325.00</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>*</strong> Dormitory package includes One Boat safari & One Road Safari by Van into Nagarahole National park.</p>
                    <p class="mt-15"><strong>Package Includes:</strong> Stay, Buffet Lunch Dinner & Breakfast with Wildife Safari into Nagarahole (Rajiv Gandhi) National Park x 2, Forest Entry Fees & Campfire.</p>
                </div>
                <div class="col-xl-12">
                    <div class="tour-plan">
                        <h3 class="tour-details-subtitle">Itinerary</h3>
                        <div class="tour-plan-single">
                            <div class="plan-serial">
                                <span>01</span>
                            </div>
                            <div class="plan-content">
                                <h4 class="plan-title">Day 01</h4>
                                <table class="event-table">
                                    <tbody>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>1:00 pm - </strong></td>
                                            <td class="event-details">
                                                Check in
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>1:30 pm - </strong></td>
                                            <td class="event-details">
                                                Buffet Lunch
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>3:00 pm - </strong></td>
                                            <td class="event-details">
                                                Safari briefing with tea/coffee
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>3:15 pm - </strong></td>
                                            <td class="event-details">
                                                Drive into Nagarahole National Park
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>6:15 pm - </strong></td>
                                            <td class="event-details">
                                                Wildlife film/slide show
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>7:30 pm - </strong></td>
                                            <td class="event-details">
                                                Buffet Dinner Around Camp-Fire
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>8:30 pm - </strong></td>
                                            <td class="event-details">
                                                Dinner
                                            </td>
                                        </tr>
                        ...
                        <div class="tour-plan-single">
                            ...
                            <div class="plan-content">
                                <h4 class="plan-title">Day 02</h4>
                                <table class="event-table">
                                    <tbody>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>5:45 am - </strong></td>
                                            <td class="event-details">
                                                Wake-up call, tea/coffee
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>6:15 am - </strong></td>
                                            <td class="event-details">
                                                Drive into the Park,Boat Safari on River Kabini
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>9:30 am - </strong></td>
                                            <td class="event-details">
                                                Breakfast At The Gol-Ghar
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>10:30 am - </strong></td>
                                            <td class="event-details">
                                                Check-out
                                            </td>
                                        </tr>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i> Tariffs are per person per night on twin-sharing basis.</li>
                                    <li><i class="bi bi-check-lg"></i> Transfers to & from our resorts are not included in the tariff.</li>
                                    <li><i class="bi bi-check-lg"></i> Single occupancy is charged at 30% of the tariff per night.</li>
                                    <li><i class="bi bi-check-lg"></i> Tariff for children (accompanying parents) between 5 and 12 years is 50%.</li>
                                    <li><i class="bi bi-check-lg"></i> Tariff May be changed without prior notice.</li>
                                    <li><i class="bi bi-check-lg"></i> Guest will bear the camera & lense entry fees.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <div class="row">
                                    <div class="col-12">
                                        <p><strong>Go Wildlife-Spotting and Bird Watching in the Nagarhole Wildlife Sanctuary: </strong> Nagarhole National Park is also known as Rajiv Gandhi National Park – a wildlife reserve in the South Indian state of Karnataka. A part of the Nilgiri Biosphere Reserve, the park has the Brahamagiri Mountains as the backdrop, filled with Teak, Rosewood and Sandalwood trees. The Kabini River flows through the picturesque jungle-scapes, making it an ideal habitat for Bengal tigers, Asian elephants, striped hyenas, leopards, sloth bears, antelopes, barking beer, jungle bison and sambar deer. More than 250 species of birds are also found here, especially near the Kabini River. Blue bearded bee-eater, Malabar whistling thrush, common osprey, duck, and herons are spotted usually.</p>
                                    </div>
                                    <div class="col-12">
                                        <p><strong>Indoor / Outdoor Games and Activities:</strong> Unwind with a variety of Indoor Games such as Table Tennis, Playing Cards, Carom Board, Snakes and Ladders, Ludo, Chess, Chinese Checkers, etc; or else engage in some physical activity as part of Outdoor Games like Cricket, Volley Ball, Badminton, or else, simply enjoy a bonfire. Boating at Kabini Dam about 46 KM away is another popular activity. For adrenaline junkies, Coorg White Water Rafting is available at a distance of 54 KM from the Resort (subject to seasonal conditions).</p>
                                    </div>
                                    <div class="col-12">
                                        <ul>
                                            <h6>Other Sightseeing</h6>
                                            <li><i class="bi bi-check-lg"></i> Located 45 KMs away, the Irupu Falls that torrent down tree-lined rocks is a popular sightseeing destination in the vicinity.</li>
                                            <li><i class="bi bi-check-lg"></i> Cascading along the Brahmagiri Mountain Range in the Coorg district of South Karnataka, also known as the LakshmanaTirtha Falls, it has religious significance too.</li>
                                            <li><i class="bi bi-check-lg"></i> Another must-visit place is Kuruvadweep or Kuruva Island (approx. 60 Km away), which is a 950-acre protected river delta comprising three densely wooded uninhabited islands and a few submergible satellite islands, in the Wayanad district, Kerala, India.</li>
                                            <li><i class="bi bi-check-lg"></i> Other tourist destinations in the vicinity are Kabini Dam at a distance of 44 KM and Brahmagiri Hill 58 KM away.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p>Kabini is surprisingly accessible. Located 5 km off the Mysore-Mananthavadi Road, it's only a few hours away from Mysore and Bangalore.</p>
                                <div class="row">
                                    <div class="col-12">
                                        <ul>
                                            <h6>Options From Bangalore To Kabini: </h6>
                                            <li><i class="bi bi-check-lg" style="color:#63ab45"></i> If you are travelling by your own car, all you have to do is reach Mysore and then follow the detailed route sketches. Incidentally, your driver can stay free of cost at our comfortable dormitory.</li>
                                            <li><i class="bi bi-check-lg" style="color:#63ab45"></i> You can hire a taxi for the to and fro journey, including a night halt at Kabini.</li>
                                            <li><i class="bi bi-check-lg" style="color:#63ab45"></i> Another alternative is to take a train ride of 2 - 2 1/2 hours from Bangalore City to Mysore, and from there proceed by car/bus to Kabini.</li>
                                        </ul>
                                    </div>
                                    <div class="col-12">
                                        <ul class="mt-4">
                                            <h6>Mysore To Kabini: </h6>
                                            <li><i class="bi bi-check-lg" style="color:#63ab45"></i> If you're arriving by train, arrange for a taxi to meet you at the station for your onward journey to Kabini.</li>
                                            <li><i class="bi bi-check-lg" style="color:#63ab45"></i> Those setting out from Ooty can follow the Bandipur, Gundlupet, Begur, Nugu Dam & Hand Post Circle for a shorter albeit bumpy route, or come via Mysore, which is a better road.</li>
                                            <li><i class="bi bi-check-lg" style="color:#63ab45"></i> Guests from Mumbai, Delhi, Calcutta, Hyderabad, Madras etc., can arrive via Bangalore.</li>
                                            <li><i class="bi bi-check-lg" style="color:#63ab45"></i> Guests from Trivandrum, Cochin & Calicut can come via Mananthavadi, along the Mysore Mananthavadi road.</li>
                                            <li><i class="bi bi-check-lg" style="color:#63ab45"></i> Guests from Mangalore & Madikeri could come via Hunsur, H.D. Kote and Hand Post Circle.</li>
                                        </ul>
                                    </div>
                                </div>

                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m24!1m8!1m3!1d997108.3886181551!2d76.3645353!3d12.5191638!3m2!1i1024!2i768!4f13.1!4m13!3e0!4m5!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBangalore%2C%20Karnataka!3m2!1d12.9715987!2d77.5945627!4m5!1s0x3ba5efdf9e66d37f%3A0xc64b4e619c0f2d71!2sKabini%20River%20Lodge%2C%20Kodagu%2C%20Karnataka!3m2!1d11.939748999999999!2d76.2704771!5e0!3m2!1sen!2sin!4v1585041707640!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
