...
<head>
    ...
    <title>Om Beach Resort, Gokarna | Relax by the Ocean in Cottages</title>
    <meta name="description" content="Enjoy serene views and a peaceful stay at Om Beach Resort, Gokarna. Relax in cosy cottages, explore nearby beaches and temples. Book your escape today!">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/om-beach-resort.php">
    ...
    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/om-resort-1.jpg" alt="Karnataka Tourism">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/om-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/om-resort-2.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/om-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/om-resort-3.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/om-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/om-resort-4.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/om-resort-4.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/om-resort-5.jpg" alt="Karnataka Tourism">
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img/resorts/om-resort-6.jpg" data-fancybox="images"><img src="../assets/img/resorts/om-resort-6.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/om-resort-7.jpg" data-fancybox="images"><img src="../assets/img/resorts/om-resort-7.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/om-resort-8.jpg" data-fancybox="images"><img src="../assets/img/resorts/om-resort-8.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/om-resort-9.jpg" data-fancybox="images"><img src="../assets/img/resorts/om-resort-9.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/om-resort-10.jpg" data-fancybox="images"><img src="../assets/img/resorts/om-resort-10.jpg" alt="Karnataka Tourism"></a>
            </div>
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    <h1 class="eco-head">Embrace Coastal Bliss at Om Beach Resort</h1>
                    ...
                    <p>Nestled in the tranquil town of Gokarna, Om Beach Resort is the perfect sanctuary for a blend of relaxation and adventure. Just a stone's throw from the stunning Om Beach—renowned for its iconic shape—this resort is your gateway to breathtaking coastal beauty. With its charming simplicity and the soothing symphony of the waves, it's the ideal spot to unwind and immerse yourself in nature's embrace. Whether you are seeking a peaceful retreat or a cultural exploration, Gokarna has something special waiting for you.</p>
                    <h3 class="mb-2" style="color:#63ab45">Relax by the Waves or Uncover Hidden Gems</h3>
                    <p>At Om Beach Resort, your day can unfold in countless delightful ways. Lounge on the sun-kissed sands, stroll along the picturesque shoreline, or dive into the rich history of Gokarna by visiting its ancient temples and feeling adventurous? Embark on a short trek to discover more hidden beaches. And if you crave tranquillity, find a cosy nook in the resort to unwind and listen to the ocean's melody. Make Om Beach Resort your next escape for the perfect balance of relaxation and exploration!</p>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Standard AC Room</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                        ...
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">EP Plan [Room Only - Food and Activities charged extra</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">2000.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">2000.00</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>Package Includes:</strong> Stay in Standard AC Room, Buffet Lunch Dinner & Breakfast with Visit to Mahabaleshwara Temple, Visit to OM Beach / Kudle Beach / Town Beach and Campfire.</p>
                </div>
                <div class="col-xl-12">
                    <div class="tour-plan">
                                ...
                                <table class="event-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="event-details">
                                                Treat yourself to a sumptuous lunch at the Gol Ghar and also cool yourself in the swimming pool/Ayurvedic massage (9:00 am -5:00pm)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>3:00 pm - </strong></td>
                                            <td class="event-details">
                                                Get ready to Go to the Beach with tea/ coffee served at the Gol Ghar
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>3:30 pm - </strong></td>
                                            <td class="event-details">
                                                The Jeep is ready at the reception to drop to Kudle/Ombeach and the same Jeep will pick you back to the Resort.
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="event-details">
                                                Bask in the warmth of the campfire, while you dine in the Gol Ghar.
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="event-table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="event-details">
                                                Visit to Shree Mahabaleshwar Temple,
                                            </td>
                                        </tr>
                                        <tr>
                ...
                <div class="col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i> The seaside town of Karwar is under an hour away from the resort. The town is famous for its calm beaches and historic sites</li>
                                    <li><i class="bi bi-check-lg"></i> About 11 kilometers away from Gokarna is the historic Mirjan Fort dating back to 1200 AD</li>
                                    <li><i class="bi bi-check-lg"></i> Visit Kali River Bridge in Karwar about an hour away from the resort</li>
                                    <li><i class="bi bi-check-lg"></i> One cannot forget Mysore which is about one and a half hour drive from the resort.</li>
                                    <li><i class="bi bi-check-lg"></i> At a mere distance of 3 kilometers from Gokarna is Our Lady of the Sea Church, which is more than a 100 years old. It is located in Bankikodla-Hanehalli village. There are several other Hindu temples in the village.</li>
                                    <li><i class="bi bi-check-lg"></i> Witness River Aghanashini merging into the Arabian Sea in the nearby Tadadi village, which is also famous for its biodiversity. It is located less than 7 kilometers away from Gokarna.</li>
                                    <li><i class="bi bi-check-lg"></i> About 4.5 kilometers from Gokarna is Torke Village, which is home to temples such as Kengala Parameshwari surrounded by a small forest called Devarakaanu.</li>
                                    <li><i class="bi bi-check-lg"></i> About 2 hours from Gokarna is the very famous, 1200 years old Kollur Mookambika Temple.</li>
                                    <li><i class="bi bi-check-lg"></i> You could also visit Sanikatta the oldest (300 years) salt-manufacturing village in the state to get a taste of the village life.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p><strong>Options From Bangalore To Om Beach :</strong> Government and private buses ply from Bangalore to Gokarna.</p>
                                <p><strong>Options From Mangalore To Om Beach :</strong> There are trains from Mangalore. / There are Nearby Airport</p>
                                <p><strong>Options From Dabolimto Om Beach :</strong>There are Nearby Airport</p>
                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3861.9384014517204!2d74.32493577479241!3d14.545515185934358!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTTCsDMyJzQzLjkiTiA3NMKwMTknMzkuMCJF!5e0!3m2!1sen!2sin!4v1690295545986!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
