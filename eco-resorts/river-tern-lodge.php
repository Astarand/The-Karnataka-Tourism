...
<head>
    ...
    <title>River Tern Lodge: Nature & Adventure in Bhadra Wildlife Sanctuary</title>
    <meta name="description" content="Stay at River Tern Lodge by the Bhadra Reservoir for nature, wildlife, and thrilling water activities. Book a peaceful escape today!">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/river-tern-lodge.php">
    ...
    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/river-resort-1.jpg" alt="Karnataka Tourism">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/river-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/river-resort-2.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/river-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/river-resort-3.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/river-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/river-resort-4.jpg" alt="Karnataka Tourism">
                                            <button class="StartSlideShowFirstImage"><i class="bi bi-plus-lg"></i> View More Images</button>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/river-resort-5.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/river-video.mp4"><i class="bi bi-play-circle"></i> Watch Video</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img/resorts/river-resort-6.jpg" data-fancybox="images"><img src="../assets/img/resorts/river-resort-6.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/river-resort-7.jpg" data-fancybox="images"><img src="../assets/img/resorts/river-resort-7.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/river-resort-8.jpg" data-fancybox="images"><img src="../assets/img/resorts/river-resort-8.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/river-resort-9.jpg" data-fancybox="images"><img src="../assets/img/resorts/river-resort-9.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/river-resort-10.jpg" data-fancybox="images"><img src="../assets/img/resorts/river-resort-10.jpg" alt="Karnataka Tourism"></a>
            </div>
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    <h1 class="eco-head">Discover Serenity and Adventure at River Tern Lodge</h1>
                    ...
                    <p>Escape to River Tern Lodge, nestled by the enchanting backwaters of Bhadra Reservoir, where nature’s beauty meets thrilling adventure. Surrounded by lush forests and serene waters, this lodge offers a unique opportunity to connect with the wilderness while soaking in breathtaking reservoir views. Named after the graceful River Tern birds that soar above, your stay here invites you to experience wildlife like never before, all within a peaceful and rejuvenating setting.</p>
                    <h3 class="mb-2" style="color:#63ab45">Delve into Nature or Relax</h3>
                    <p>At River Tern Lodge, you’ll find various activities for adventurers and leisure seekers. Join a thrilling boat safari on the reservoir, indulge in birdwatching, or navigate the picturesque trekking trails through vibrant forests—there’s something for everyone. For those who wish to unwind, relax on your cottage’s porch and relish the stunning landscape. Whether you crave excitement or tranquillity, River Tern Lodge promises an extraordinary escape. Book your stay today to discover this idyllic retreat for yourself!</p>
                ...
                <div class="col-xl-4">
                    <div class="contact-page">
                        ...
                        <div class="single-contact mb-40">
                            ...
                            <div class="content">
                                <h6>
                                    Behind Ranganathaswamy Temple,<br>
                                    Bhadra Project, Lakkavalli,<br>
                                    Around Chikmagalur - 577 115<br>
                                    Karnataka, India.
                                </h6>
                            </div>
                        </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">7930.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">9330.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                    ...
                    <p class="mt-15"><strong>Package Includes:</strong> Stay, Buffet Lunch Dinner & Breakfast with Jeep Safari into the Bhadra Tiger Reserve, Boat Safari, Kayaking and swimming at the Water Sports area, Forest Entry Fees & Campfire.</p>
                </div>
                <div class="col-xl-12">
                    <div class="tour-plan">
                ...
                <div class="col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i> The temple town of Sringeri is just under 2 hours from River Tern Lodge..</li>
                                    <li><i class="bi bi-check-lg"></i> About 50 kilometers from the resort is Kemmangundi which was once the summer retreat of Mysore Royals.</li>
                                    <li><i class="bi bi-check-lg"></i> You can go on a short trek in Kudremukh, a Reserved Forest, just about 2 hours away.</li>
                                    <li><i class="bi bi-check-lg"></i> One cannot forget Mysore which is about one and a half hour drive from the resort.</li>
                                    <li><i class="bi bi-check-lg"></i> If you have enough time in your hands are an avid trekker, don’t miss Mullayyanagiri, the highest peak in the state. It is hardly 2 hours from the resort.</li>
                                    <li><i class="bi bi-check-lg"></i> You can also plan a drive to Hanumanagundi or Hebbe Falls.</li>
                                    <li><i class="bi bi-check-lg"></i> A little over 2 hours is the historic Belur, with its temples dating back to Hoysala period.</li>
                                    <li><i class="bi bi-check-lg"></i> Also at 2-hour distance is Halebeedu, which was once the capital of Hoysala rulers.</li>
                                    <li><i class="bi bi-check-lg"></i>Just over 2 hours is the famous Annapoorneshwari Temple in Hornadu town. The deity is believed to have been put in place by the great Adi Shankaracharya.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p><strong>From Bangalore:</strong> Drive towards Tumkur. Take the Shimoga bypass road at Tumkur (instead of going to Tumkur town) and cross Gubbi, Tiptur, Arsikere, Kadur, Birur, Tarikere. After crossing Tarikere, take the left that also has a Kuvempu University direction board. Travel 14 km till you reach Lakkavalli. At Lakkavalli, you will find a sign board to the River Tern Lodge, which is about 4km away. Alternately you can contact the Range Forest Office at Lakkavalli for enquiries. The River Tern Lodge is 38 km from Shimoga and is located by the Bhadra Reservoir.</p>
                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3876.3667746154297!2d75.63275837477539!3d13.696222186689907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTPCsDQxJzQ2LjQiTiA3NcKwMzgnMDcuMiJF!5e0!3m2!1sen!2sin!4v1690295465752!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
