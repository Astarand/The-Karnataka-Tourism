...
<head>
    ...
    <title>Hampi Heritage Resort – Enjoy Nature, Adventure & Heritage</title>
    <meta name="description" content="Stay at Hampi Heritage & Wilderness Resort, where adventure meets history. Explore wildlife, heritage trails, and enjoy a unique safari experience.">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/hampi-heritage-wilderness-resort.php">
    ...
    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/hampi-resort-1.jpg" alt="Karnataka Tourism">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/hampi-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/hampi-resort-2.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/hampi-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/hampi-resort-3.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/hampi-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/hampi-resort-4.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/hampi-resort-4.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/hampi-resort-5.jpg" alt="Karnataka Tourism">
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img/resorts/hampi-resort-6.jpg" data-fancybox="images"><img src="../assets/img/resorts/hampi-resort-6.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/hampi-resort-7.jpg" data-fancybox="images"><img src="../assets/img/resorts/hampi-resort-7.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/hampi-resort-8.jpg" data-fancybox="images"><img src="../assets/img/resorts/hampi-resort-8.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/hampi-resort-9.jpg" data-fancybox="images"><img src="../assets/img/resorts/hampi-resort-9.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/hampi-resort-10.jpg" data-fancybox="images"><img src="../assets/img/resorts/hampi-resort-10.jpg" alt="Karnataka Tourism"></a>
            </div>
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    <h1 class="eco-head">Welcome to Hampi Heritage & Wilderness Resort</h1>
                    ...
                    <h3 class="mb-2" style="color:#63ab45">Where History Dances with Nature's Splendor</h3>
                    <p>Embark on a remarkable journey at Hampi Heritage & Wilderness Resort—a perfect haven for travellers eager to delve into the captivating cultural tapestry of Hampi while enveloped in nature's embrace. Nestled near the UNESCO World Heritage Site, our resort places you just moments away from Hampi's ancient temples, majestic ruins, and breathtaking landscapes.</p>
                    <p>Unwind in our charming cottages, surrounded by lush greenery, after an exhilarating day of exploration. Whether you're a history buff or simply searching for a serene retreat, we offer an idyllic escape where the past and nature intertwine beautifully.</p>

                    <h3 class="mb-2" style="color:#63ab45">Unearth Hampi's Treasures and Embrace the Wild </h3>
                    <p>At Hampi Heritage & Wilderness Resort, each day unfolds a new chapter of adventure. Start your mornings wandering through ancient ruins and sacred temples, then set out for afternoon treks that reveal the stunning wilderness surrounding you. The nearby wildlife sanctuary beckons with the promise of vibrant flora and fauna, adding an exhilarating touch to your experience.</p>
                    <p>With its enchanting blend of heritage and natural beauty, our resort invites you to immerse yourself in Hampi's profound essence. Plan your visit now and discover the magic that awaits in this extraordinary destination!</p>
                </div>
                <div class="col-xl-4">
                    <div class="contact-page">
                        ...
                        <div class="single-contact mb-40">
                            ...
                            <div class="content">
                                <h6>
                                    Near Kannada University, P.K.Halli<br>
                                    Road, Kamalapura, Hospet Taluk,<br>
                                    Bellary - 583276,<br>
                                    Karnataka, India.
                                </h6>
                            </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">3720.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">4370.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Executive Cottage</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">5270.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">6195.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">CP Plan [Only Room - with Complementary Breakfast]</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">1860.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">NA</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>Package Includes:</strong>Stay, Buffet Lunch Dinner & Breakfast with Jeep Safari to Daroji Wildlife Sanctuary, Hampi sightseeing (Holy Enclosure), Forest Entry Fees & Campfire.</p>
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block" style="border: 1px solid #ddd"></div>
                        <div class="col-lg-6" style="border: 1px solid #ddd">
                            <h5 class="text-center py-1">Price in ₹ ( INR )</h5>
                        ...
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Day Visit</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">2420.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">2420.00</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>Package Includes:</strong>Welcome Drink, Visit to Zoo, Buffet Lunch, Daroji Bear Safari, Evening Tea / Coffee </p>
                </div>
                <div class="col-xl-12">
                    <div class="tour-plan">
                            ...
                            <div class="plan-content">
                                ...
                                <table class="event-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>3:30 pm - </strong></td>
                                            <td class="event-details">
                                        ...
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>9:30 pm - </strong></td>
                                            <td class="event-details">
                            ...
                            <div class="plan-content">
                                ...
                                <table class="event-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>8:00 am - </strong></td>
                                            <td class="event-details">
                                                Breakfast
                                            </td>
                                        </tr>
                            ...
                            <div class="plan-content">
                                ...
                                <table class="event-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>9:00 am - </strong></td>
                                            <td class="event-details">
                ...
                <div class="col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i> The original capital of Vijayanagara Kingdom, Anegundi, is about 40 kilometers away and has several historical sites too.</li>
                                    <li><i class="bi bi-check-lg"></i> At about 2 and a half hours from Hampi are several historical sites, one of which is Pattadakal.</li>
                                    <li><i class="bi bi-check-lg"></i> About 2 hours from Hampi is Aihole, the first capital of the Chalukyas, with several historical temples and other structures.</li>
                                    <li><i class="bi bi-check-lg"></i> You will reach Gajendragad under two hours from Hampi. Kalakaleshwara Temple and the historic fort are its prime attractions.</li>
                                    <li><i class="bi bi-check-lg"></i> About two and a half hours from Hampi is Badami, which stands ode to the Chalukya architecture and is perhaps most famous for its cave temples.</li>
                                    <li><i class="bi bi-check-lg"></i> If you are willing to travel the distance, it will take you 3 hours to reach Bijapur which is home to some of the most beautiful Mughal architectural structures, like the Gol Gumbaz.</li>
                                    <li><i class="bi bi-check-lg"></i> If you are not in the mood to travel a lot, visit Hospet which is just about 12 kilometers from Hampi. It is home to some ancient temples like Sri Jambunatha Temple that take you back to the mythological era of Ramayana.</li>
                                    <li><i class="bi bi-check-lg"></i> Just over half an hour from Hampi is Tungabhadra Dam. Enjoy the spectacular view of never-ending expanse of water here.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p>The Sloth Bear Heritage Resort is located in Kamalapur at a distance of 365 Km from Bangalore and Goa (Madgaon) and 415 Km from Hyderabad.</p>
                                <P><strong>By Road:</strong> From Bangalore you can reach Kamalapur via Nelamangala, Tumkur, Chitradurga and Hospet. Take NH4 from Bangalore to Chitradurga (199 Km) and NH13 from Chitradurga to Hospet (135 Km). 12 Km from Hospet is Kalamapur. Once at Kamalapur, turn right at Ambedkar Circle towards Kannada University Road leading to P.K. Halli.</P>
                                <p><strong>By Rail: </strong> Hospet and Munirabad are the nearest railheads. Pickup and drop facilities are available at an extra cost.</p>
                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m24!1m8!1m3!1d1980160.8496786908!2d76.0159953!3d14.2239327!3m2!1i1024!2i768!4f13.1!4m13!3e6!4m5!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBangalore%2C%20Karnataka!3m2!1d12.9715987!2d77.5945627!4m5!1s0x3bb77da4b553e0fb%3A0xb36e9bbecd46a0a7!2sHampi%20Heritage%20and%20Wilderness%20Resort%2C%20Hosapete%2C%20Karnataka!3m2!1d15.263579499999999!2d76.48905859999999!5e0!3m2!1sen!2sin!4v1611561658361!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
