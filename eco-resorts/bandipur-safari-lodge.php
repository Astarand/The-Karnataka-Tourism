...
<head>
    ...
    <title>Experience Bandipur Safari Lodge | Karnataka Tourism</title>
    <meta name="description" content="Discover Bandipur Safari Lodge, where nature meets comfort. Enjoy thrilling wildlife safaris and serene stays in Karnataka's lush Bandipur forests.">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/bandipur-safari-lodge.php">
    ...
    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/bandipur-resort-1.jpg" alt="Karnataka Toursim">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/bandipur-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/bandipur-resort-2.jpg" alt="Karnataka Toursim">
                                            <a data-fancybox="gallery-01" href="../assets/img//resorts/bandipur-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img//resorts/bandipur-resort-3.jpg" alt="Karnataka Toursim">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/bandipur-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img//resorts/bandipur-resort-4.jpg" alt="Karnataka Toursim">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/bandipur-resort-4.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img//resorts/bandipur-resort-5.jpg" alt="Karnataka Toursim">
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img//resorts/bandipur-resort-6.jpg" data-fancybox="images"><img src="../assets/img//resorts/bandipur-resort-6.jpg" alt="Karnataka Toursim"></a>
                <a href="../assets/img//resorts/bandipur-resort-7.jpg" data-fancybox="images"><img src="../assets/img//resorts/bandipur-resort-7.jpg" alt="Karnataka Toursim"></a>
                <a href="../assets/img//resorts/bandipur-resort-8.jpg" data-fancybox="images"><img src="../assets/img//resorts/bandipur-resort-8.jpg" alt="Karnataka Toursim"></a>
                <a href="../assets/img//resorts/bandipur-resort-9.jpg" data-fancybox="images"><img src="../assets/img//resorts/bandipur-resort-9.jpg" alt="Karnataka Toursim"></a>
                <a href="../assets/img//resorts/bandipur-resort-10.jpg" data-fancybox="images"><img src="../assets/img//resorts/bandipur-resort-10.jpg" alt="Karnataka Toursim"></a>
            </div>

            <div class="col-xl-12">
                <h1 class="eco-head">Discover Bandipur Safari Lodge</h1>
            ...
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8 order-1 order-xl-0">
                    ...
                    <div>
                        <h3 class="mb-2" style="color:#63ab45">Your Gateway to Nature and Adventure</h3>
                        <p>Bandipur Safari Lodge is an ideal escape for travellers seeking a close connection with nature. Situated near Bandipur National Park, the lodge offers a unique opportunity to experience this protected forest area's rich wildlife and serene beauty. Whether you're hoping to spot tigers, elephants, or various bird species, your time here will bring you face-to-face with the wilderness responsibly and sustainably. With thoughtfully designed accommodations and expert naturalists to guide your explorations, Bandipur Safari Lodge blends comfort with an authentic wildlife experience.</p>
                        <h3 class="mb-2" style="color:#63ab45">Adventures Await Every Day</h3>
                        <p>Every day presents a new adventure, from guided safari tours to peaceful nature walks. In the evening, return to the lodge to relax and reflect on your experiences. The lodge encourages travellers to connect with nature, whether by enjoying the sights and sounds of the forest or learning about conservation efforts. Take the first step toward your wilderness adventure today and book your stay at Bandipur Safari Lodge.</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Standard Cottage [Viceroy Package] </p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">7030.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">8260.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Special Cottage [Maharaja Package] - AC</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">8425.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">9920.00</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>Package Includes:</strong> Stay, Buffet Lunch Dinner & Breakfast with Jeep Safari into Bandipur Tiger Reserve x 2, Wildlife film show, Forest Entry Fees & Campfire.</p>
                </div>
                <div class="col-xl-12">
                    <div class="tour-plan">
                                ...
                                <table class="event-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="event-details">
                                                Drive into Bandipur National Park
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i> Tariffs are per person per night on a twin-sharing basis.</li>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i> Ask for a local guide and trek down to Gurupura River.</li>
                                    <li><i class="bi bi-check-lg"></i> Take a trip to the Artisan Village.</li>
                                    <li><i class="bi bi-check-lg"></i> Take a tour of the Dr.Shivaram Karanth Biological Park nearby.</li>
                                    <li><i class="bi bi-check-lg"></i> Spend some fun hours at the Manasa Amusement and Water Park.</li>
                                    <li><i class="bi bi-check-lg"></i> Experience the calmness of Panambur Beach.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p>The nearest airport is Mysore (80 km), though very limited flights land there currently. Extremely good roads connect Bandipur to Bangalore (220 km), Mysore (80 km), Coimbatore (170 km) and Ooty (80 km).</p>
                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m24!1m8!1m3!1d997566.8202708447!2d76.5594596!3d12.3999704!3m2!1i1024!2i768!4f13.1!4m13!3e6!4m5!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBangalore%2C%20Karnataka!3m2!1d12.9715987!2d77.5945627!4m5!1s0x3ba8ad875959abc7%3A0xf4dbc092f39c62de!2sBandipur%20Safari%20Lodge%2C%20Bandipur%2C%20Nagapattinam%20-%20Coimbatore%20-%20Gundlupet%20Highway%2C%20Mel%20Kamanahalli%2C%20Karnataka!3m2!1d11.7033373!2d76.6412288!5e0!3m2!1sen!2sin!4v1584946312235!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
