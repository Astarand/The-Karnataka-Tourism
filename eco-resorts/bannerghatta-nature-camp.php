...
<head>
    ...
    <title>Bannerghatta Nature Camp: An Unspoilt Jungle Near Bangalore</title>
    <meta name="description" content="Experience the wild at Bannerghatta Nature Camp. Stay in comfortable tents, enjoy safaris, and explore 25,000 acres of preserved jungle near Bangalore.">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/bannerghatta-nature-camp.php">
    ...
    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/bannerghatta-resort-1.jpg" alt="Karnataka Toursim">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/bannerghatta-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/bannerghatta-resort-2.jpg" alt="Karnataka Toursim">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/bannerghatta-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/bannerghatta-resort-3.jpg" alt="Karnataka Toursim">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/bannerghatta-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/bannerghatta-resort-4.jpg" alt="Karnataka Toursim">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/bannerghatta-resort-4.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/bannerghatta-resort-5.jpg" alt="Karnataka Toursim">
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img/resorts/bannerghatta-resort-6.jpg" data-fancybox="images"><img src="../assets/img/resorts/bannerghatta-resort-6.jpg" alt="Karnataka Toursim"></a>
                <a href="../assets/img/resorts/bannerghatta-resort-7.jpg" data-fancybox="images"><img src="../assets/img/resorts/bannerghatta-resort-7.jpg" alt="Karnataka Toursim"></a>
                <a href="../assets/img/resorts/bannerghatta-resort-8.jpg" data-fancybox="images"><img src="../assets/img/resorts/bannerghatta-resort-8.jpg" alt="Karnataka Toursim"></a>
                <a href="../assets/img/resorts/bannerghatta-resort-9.jpg" data-fancybox="images"><img src="../assets/img/resorts/bannerghatta-resort-9.jpg" alt="Karnataka Toursim"></a>
                <a href="../assets/img/resorts/bannerghatta-resort-10.jpg" data-fancybox="images"><img src="../assets/img/resorts/bannerghatta-resort-10.jpg" alt="Karnataka Toursim"></a>
            </div>
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    <h1 class="eco-head">Discover the Tranquility of Bannerghatta Nature Camp</h1>
                    ...
                    <p>Located on the outskirts of Bangalore, Bannerghatta Nature Camp offers a peaceful retreat into nature. Experience the lush greenery and diverse wildlife of Bannerghatta National Park. Whether you want to relax in a serene environment or explore the wonders of the outdoors, this camp provides the perfect setting. The natural surroundings encourage you to take a break from the hustle and bustle of daily life and reconnect with nature.</p>
                    <h3 class="mb-2" style="color:#63ab45">A Blend of Adventure and Relaxation</h3>
                    <p>Explore the enchanting world of Bannerghatta Nature Camp, where adventure and tranquillity come together! Immerse yourself in nature with thrilling activities, from guided nature walks to exciting wildlife safaris. Picture yourself spotting majestic elephants, graceful deer, and a wide variety of birds as they roam in their natural habitat.</p>
                    <p>If you're seeking peace, the camp offers plenty of tranquil spots to relax and enjoy breathtaking views. Whether planning a rejuvenating solo retreat or a memorable family getaway, this camp promises an unforgettable escape into the wild.</p>
                    <p>Why wait? Uncover the wonders of nature and create lasting memories on your next adventure!</p>
                ...
                <div class="col-xl-4">
                    <div class="contact-page">
                        ...
                        <div class="single-contact mb-40">
                            ...
                            <div class="content">
                                <h6>
                                    Bannerghatta-Kagalipura Road<br>
                                    Near Hakki-Pikki Colony,<br>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Log Hut</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">5620.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">6610.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Wodden Cottage</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                        ...
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Swiss Tent</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">4420.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">5195.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Executive Tent</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">4720.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">5550.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Deluxe Dormitory [5 Bedded x 2]</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">2900.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">2900.00</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>Package Includes:</strong> Stay, Buffet Lunch Dinner & Breakfast with Grand Safari, Guided Nature Walk, Visit to the Zoo & Butterfly Park & Campfire.</p>
                    <div class="row">
                        <h4>Package Costing</h4>
                        <div class="col-lg-6 d-none d-lg-block" style="border: 1px solid #ddd"></div>
                        <div class="col-lg-6" style="border: 1px solid #ddd">
                        ...
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">1450.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">1450.00</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>Package Includes :</strong> Welcome Drink, Buffet Lunch, Evening Tea / Coffee with Herbivore Safari, Lion- Tiger-Bear Safari, Visit to the Zoo & Butterfly Park</p>
                </div>
                <div class="col-xl-12">
                    <div class="tour-plan">
                            ...
                            <div class="plan-content">
                                ...
                                <table class="event-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>2:45 pm - </strong></td>
                                            <td class="event-details">
                                                Gear up for a ride into the Park with tea/ coffee served at the Reception area with safari briefing
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>2:30 pm - </strong></td>
                                            <td class="event-details">
                                                Our naturalists take you on a wildlife Safari in Vehicle and visit to Butterfly park into Bannergatta Biological park, showing & sharing their experiences and information about the jungle and all the animals that live there
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <table class="event-table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="event-details">
                                                wakeup call , Tea/ coffee served at the Reception area
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>6:15 am - </strong></td>
                                            <td class="event-details">
                                                Our naturalists take you to the nature trail herbivore safari, showing & sharing their experiences and information about the jungle and all the animals that live there.
                                            </td>
                                        </tr>
                                        <tr>
                ...
                <div class="col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i>Hajjamana Kallu is only 3.9 km from Bannerghatta National Park. This mammoth rock makes for a great view point.</li>
                                    <li><i class="bi bi-check-lg"></i>Visit Bannerghatta Santhe, which is a mere half kilometers from the resort and is ideal for shopping souvenirs.</li>
                                    <li><i class="bi bi-check-lg"></i>Take time to drive down to the scenic Jigani Lake situated about 3.6 km away.</li>
                                    <li><i class="bi bi-check-lg"></i>Champakadama Swamy shrine is located near the Park. You can visit the place en route to Bangalore.</li>
                                    <li><i class="bi bi-check-lg"></i>he famous Suvarnamukhi Kalyani pond is only 2 kilometers from here.</li>
                                    <li><i class="bi bi-check-lg"></i>Suvanramukhi falls also known as Thottikal falls is very close to the Bannerghatta National Park.</li>
                                    <li><i class="bi bi-check-lg"></i>Bheemeshwari, the riverside natural haven is only about 2 hours away.</li>
                                    <li><i class="bi bi-check-lg"></i>Driving a little over 2 hours will take you to Muthathi where you can spend some quiet time by the river surrounded by greenery.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p>Bannerghatta Nature Camp is situated within the Bannerghatta National Park. From Bangalore downtown (M.G Road/ Brigade Road area), one needs to drive south to Bannerghatta Road, which is off Hosur road near Wilson Garden. From this point, the National Park is about 20 km (40 min drive) away and easy to find with many direction boards en-route.</p>
                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5794.770847334783!2d77.55507736823533!3d12.79881962757511!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae41e3085e3527%3A0x901521035c4ed90!2sBannerghatta%20Nature%20Camp-Jungle%20Lodges!5e0!3m2!1sen!2sin!4v1690295948972!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
