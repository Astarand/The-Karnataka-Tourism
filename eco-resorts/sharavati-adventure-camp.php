...
<head>
    ...
    <title>Sharavathi Adventure Camp: Your Perfect Nature Escape</title>
    <meta name="description" content="Experience nature’s beauty at Sharavathi Adventure Camp. Stay in cosy cottages, enjoy thrilling activities, explore Jog Falls and the Sahyadri mountains.">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/sharavati-adventure-camp.php">
    ...
    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/sharavati-resort-1.jpg" alt="Karnataka Tourism">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/sharavati-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/sharavati-resort-2.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/sharavati-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/sharavati-resort-3.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/sharavati-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/sharavati-resort-4.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/sharavati-resort-4.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/sharavati-resort-5.jpg" alt="Karnataka Tourism">
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img/resorts/sharavati-resort-6.jpg" data-fancybox="images"><img src="../assets/img/resorts/sharavati-resort-6.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/sharavati-resort-7.jpg" data-fancybox="images"><img src="../assets/img/resorts/sharavati-resort-7.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/sharavati-resort-8.jpg" data-fancybox="images"><img src="../assets/img/resorts/sharavati-resort-8.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/sharavati-resort-9.jpg" data-fancybox="images"><img src="../assets/img/resorts/sharavati-resort-9.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/sharavati-resort-10.jpg" data-fancybox="images"><img src="../assets/img/resorts/sharavati-resort-10.jpg" alt="Karnataka Tourism"></a>
            </div>
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    <h1 class="eco-head">Explore the Untouched Beauty of Sharavati Adventure Camp</h1>
                    ...
                    <p>Sharavati Adventure Camp is nestled near the tranquil backwaters of the Sharavati River, offering a perfect escape into Karnataka's scenic wilderness. Located near Jog Falls, this camp combines natural beauty with outdoor adventure. Surrounded by dense forests and calm waters, it is an ideal destination for nature lovers seeking relaxation and exploration. The camp's peaceful environment encourages you to disconnect from the hustle of modern life and enjoy the simplicity of the great outdoors.</p>
                    <h3 class="mb-2" style="color:#63ab45">Unwind or Seek Adventure</h3>
                    <p>Sharavati Adventure Camp offers a variety of activities to suit different interests. Whether you prefer kayaking on tranquil waters or exploring forest trails, this camp has something for everyone. For those looking to take it slow, the serene surroundings offer ample space for reflection and relaxation. Birdwatchers will also find abundant wildlife to observe in the area. Plan your next adventure here and immerse yourself in the natural beauty of Sharavati's landscapes.</p>
                ...
                <div class="col-xl-4">
                    <div class="contact-page">
                        ...
                        <div class="single-contact mb-40">
                            ...
                            <div class="content">
                                <h6>
                                    Kargal-Jog falls Sagar Taluk<br>
                                    Shivamoga Dist - 577421<br>
                                    Karnataka, India.
                                </h6>
                            </div>
                        </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">4220.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">4960.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Special Cottage [AC]</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">5020.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">5900.00</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>Package Includes:</strong> Stay, Buffet Lunch, Dinner & Breakfast with Coracle ride / Boating / Kayaking, Visit to Jog Falls, Documentary film screening and Campfire.</p>
                </div>
                <div class="col-xl-12">
                    <div class="tour-plan">
                                ...
                                <table class="event-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="event-details">
                                                Bask in the warmth of the campfire, while you dine in the dinning hall, exchanging tales of the jungle with the other guests and our staff
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="event-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="event-details">
                                                Visit to Jog Falls / Nature walk/ Bird-watching
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>9:00 am - </strong></td>
                                            <td class="event-details">
                                                Breakfast at dinning hall
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>10:30 pm - </strong></td>
                                            <td class="event-details">
                                                Check out
                                            </td>
                                        </tr>
                ...
                <div class="col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i>Boating, Kayaking, and Coracle Rides are experiences worth indulging in here. With qualified personnel and safety gear to protect you, there’s no stopping you!</li>
                                    <li><i class="bi bi-check-lg"></i>At Sharavathi Adventure Camp, you also get guided tours through the wild with all safety precautions taken. The Jungle treks and nature walks that you take will be cherished forever.</li>
                                    <li><i class="bi bi-check-lg"></i>The resort and the surrounding islands attract a wide variety of winged visitors. Several varieties of butterflies can also be found in the vicinity of the resort. Mammals like the Black-naped Hare, Common Langurs, and Malabar Giant Squirrel are also spotted occasionally.</li>
                                    <li><i class="bi bi-check-lg"></i>One cannot forget Mysore which is about one and a half hour drive from the resort.</li>
                                    <li><i class="bi bi-check-lg"></i>At the Sharavathi Adventure Camp, you are cradled in nature’s lap and left to enjoy the ethereal beauty of the Sahyadris.</li>
                                    <li><i class="bi bi-check-lg"></i>Birding is a popular activity around here; you will be amazed at the variety of butterflies spotted! An exciting aquatic life can be spotted too, while you indulge in water-based activities.</li>
                                    <li><i class="bi bi-check-lg"></i>You can also head out for a drive into the misty, densely-wooded forest of the Sharavathi Valley Wildlife Sanctuary. The sanctuary encompasses a part of the Sharavathi river basin and has evergreen and moist deciduous forests.</li>
                                    <li><i class="bi bi-check-lg"></i>Sightseeing trips to nearby tourist attractions like Linganamakki Dam, Unchalli Falls, Burude Falls and Sigandur are options too.</li>
                                    <li><i class="bi bi-check-lg"></i>Guided Trekking, Nature Walk, Kayaking, Coracle Ride, Boating, Bird Watching, Sightseeing</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p>Sharavathi Adventure Camp is easily accessible via road, rail or air. The nearest airport is Bengaluru (approx. 400+ km), Click here for details (link to How to Reach with a route map and other information).</p>
                                <h5>Reaching Sharavathi Adventure Camp</h5>
                                <p><strong>By Road –</strong> The resort is situated at a distance of about 409 KM from Bangalore</p>
                                <p><strong>By Rail –</strong> The nearest railway station is at Talguppa with frequent trains to Bangalore.</p>
                                <p><strong>By Air – </strong> The nearest airport is Kempegowda International Airport in Bangalore.</p>
                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8127.8031676258!2d74.79301768629209!3d14.187599667571984!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbc0d4172a9358b%3A0xc70920fe478b8104!2sSharavathi%20Adventure%20Camp%2C%20Jog-Junglelodges!5e0!3m2!1sen!2sin!4v1690295664786!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
