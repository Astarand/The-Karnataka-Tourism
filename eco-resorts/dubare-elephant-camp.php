...
<head>
    ...
    <title>Dubare Elephant Camp | Experience Karnataka's Wildlife</title>
    <meta name="description" content="Visit Dubare Elephant Camp to observe elephants up close, enjoy forest trails, and immerse yourself in the natural beauty of Karnataka. Plan your visit now.">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/dubare-elephant-camp.php">
    ...
    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/dubre-resort-1.jpg" alt="Karnataka Tourism">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/dubre-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/dubre-resort-2.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/dubre-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/dubre-resort-3.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/dubre-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/dubre-resort-4.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/dubre-resort-4.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/dubre-resort-5.jpg" alt="Karnataka Tourism">
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img/resorts/dubre-resort-6.jpg" data-fancybox="images"><img src="../assets/img/resorts/dubre-resort-6.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/dubre-resort-7.jpg" data-fancybox="images"><img src="../assets/img/resorts/dubre-resort-7.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/dubre-resort-8.jpg" data-fancybox="images"><img src="../assets/img/resorts/dubre-resort-8.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/dubre-resort-9.jpg" data-fancybox="images"><img src="../assets/img/resorts/dubre-resort-9.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/dubre-resort-10.jpg" data-fancybox="images"><img src="../assets/img/resorts/dubre-resort-10.jpg" alt="Karnataka Tourism"></a>
            </div>
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    <h1 class="eco-head">Welcome to Dubare Elephant Camp</h1>
                    ...
                    <h3 class="mb-2" style="color:#63ab45">Immerse Yourself in Nature and Wildlife</h3>
                    <p>Step into the enchanting world of Dubare Elephant Camp, where adventure meets serenity. Nestled along the picturesque banks of the Cauvery River, this camp offers an incredible chance to live harmoniously alongside majestic elephants. Experience the thrill of interacting with these gentle giants in a way that respects their natural behaviours, all while surrounded by the breathtaking beauty of the forest. Our cosy accommodations seamlessly blend with nature, ensuring you can unwind and fully embrace the tranquillity of your rustic retreat.</p>
                    <h3 class="mb-2" style="color:#63ab45">Uncover Adventure and Connection</h3>
                    <p>Every day at Dubare Elephant Camp is filled with exciting opportunities to dive deeper into the wonders of wildlife. Marvel at the sight of elephants enjoying their bath or glean insights into their fascinating behaviours from our knowledgeable naturalists. Venture into the lush landscape with guided treks or set off on a unique coracle ride along the river. Whether you’re seeking a thrilling escapade or a moment of peace in nature, Dubare Elephant Camp promises a memorable experience that connects you to the wild in the most delightful way. Start planning your adventure today and set off on an unforgettable journey!</p>
                ...
                <div class="col-xl-4">
                    <div class="contact-page">
                        ...
                        <div class="single-contact mb-40">
                            ...
                            <div class="content">
                                <h6>
                                    Nanjarajapatna post, Kushalanagar,<br>
                                    Somwarpet Taluk, Coorg district,<br>
                                    Hobli, Around Mysore - 571234<br>
                                    Karnataka, India.
                                </h6>
                            </div>
                        </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Forest View Cottage</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">5420.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">6375.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">River View Cottage</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">5870.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">6910.00</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>Package Includes:</strong> Stay, Buffet Lunch, Dinner & Breakfast with Jeep Safari into the Dubare Forest, Elephant Interaction, Bird Watching / Trekking & Campfire.</p>
                </div>
                            ...
                            <div class="plan-content">
                                ...
                                <table class="event-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>8:00 pm - </strong></td>
                                            <td class="event-details">
                                                Dinner
                                            </td>
                                        </tr>
                ...
                <div class="col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i> An hour’s drive through scenic surroundings will take you to the most famous water fall of Coorg, Abbi falls.</li>
                                    <li><i class="bi bi-check-lg"></i> Raja’s seat is about 25 kilometers from the resort and offers a breath-taking view of Madikeri.</li>
                                    <li><i class="bi bi-check-lg"></i> Tala Kaveri is believed to be the birthplace of river Cauvery and is located about 70 kilometers away.</li>
                                    <li><i class="bi bi-check-lg"></i> Cauvery Nisargadhama is only about 12 kilometers away from the resort. This is among the most popular picnic spots in the vicinity.</li>
                                    <li><i class="bi bi-check-lg"></i> Harangi Dam is only 17 kilometers from the resort and is another popular picnic spot.</li>
                                    <li><i class="bi bi-check-lg"></i> Tibetan Monastery allows you to get a taste of Tibetan culture. You will enjoy shopping for souvenirs here. It is a mere 15 kilometers away.</li>
                                    <li><i class="bi bi-check-lg"></i> Watching Chiklihole Dam in its full glory will fill your senses with fear and excitement at the same time. It is only 7 kilometers away.</li>
                                    <li><i class="bi bi-check-lg"></i> Just over a two-hour drive from Dubare takes you to the historic Belur and Halebeedu.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p>Dubare Elephant Camp is located in the Coorg (Kodagu) district, a popular destination in the tourist circuit. Easily accessible from Bangalore, the route is via Mysore, Kushalnagar, Gudde Hosur (4km from Kushalnagar on BM Road), then a left turn towards Siddapura. 15 km down the Siddapur Main Road, you'll find the JLR Dubare Camp signboard. Take a left turn and about a kilometre's drive would get you to the banks of the River Cauvery. Cross the river by boat and find yourself at the Dubare Elephant Camp.</p>
                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3897.1535706423024!2d75.89785757475077!3d12.37264358789038!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba5a7089fa8ecc5%3A0x34c9731dce439f1b!2sDubare%20elephant%20camp!5e0!3m2!1sen!2sin!4v1690295827170!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
