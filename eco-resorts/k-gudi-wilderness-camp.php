...
<head>
    ...
    <title>K Gudi Wilderness Camp | Stay in the Heart of BRT Tiger Reserve</title>
    <meta name="description" content="K Gudi Wilderness Camp offers a serene escape in the BRT Tiger Reserve, with safari experiences and close encounters with wildlife. Book your stay now!">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/k-gudi-wilderness-camp.php">
    ...
    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/kgudi-resort-1.jpg" alt="Karnataka Tourism">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/kgudi-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/kgudi-resort-2.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/kgudi-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/kgudi-resort-3.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/kgudi-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/kgudi-resort-4.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/kgudi-resort-4.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/kgudi-resort-5.jpg" alt="Karnataka Tourism">
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img/resorts/kgudi-resort-6.jpg" data-fancybox="images"><img src="../assets/img/resorts/kgudi-resort-6.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/kgudi-resort-7.jpg" data-fancybox="images"><img src="../assets/img/resorts/kgudi-resort-7.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/kgudi-resort-8.jpg" data-fancybox="images"><img src="../assets/img/resorts/kgudi-resort-8.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/kgudi-resort-9.jpg" data-fancybox="images"><img src="../assets/img/resorts/kgudi-resort-9.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/kgudi-resort-10.jpg" data-fancybox="images"><img src="../assets/img/resorts/kgudi-resort-10.jpg" alt="Karnataka Tourism"></a>
            </div>
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    <h1 class="eco-head">Experience the Untamed Beauty of K Gudi Wilderness Camp</h1>
                    ...
                    <p>Immerse yourself in the breathtaking beauty of K Gudi Wilderness Camp, nestled within the stunning Biligiri Rangana Hills. This extraordinary destination allows you to reconnect with nature, far removed from the hustle and bustle of daily life. Situated in a protected tiger reserve, the camp offers a unique opportunity to witness wildlife in their natural habitat while enjoying the perfect blend of comfort and wilderness.</p>
                    <h3 class="mb-2" style="color:#63ab45">Embark on an Adventure into the Wild</h3>
                    <p>At K Gudi Wilderness Camp, every moment invites you to explore the wild. Engage in thrilling guided jungle safaris and serene nature walks, where you can discover the area’s rich biodiversity, including majestic elephants, elusive leopards, and various vibrant bird species. If you seek relaxation instead, the serene environment provides an ideal setting to unwind and embrace the soothing sounds of nature. Whether you’re an adventure seeker or simply yearning for a tranquil escape, K Gudi Wilderness Camp is your ultimate getaway. Plan your visit now and answer the call of the wild!</p>
                </div>
                <div class="col-xl-4">
                    <div class="contact-page">
                        ...
                        <div class="single-contact mb-40">
                            ...
                            <div class="content">
                                <h6>
                                    K.Gudi Wilderness Camp,<br>
                                    P.O. Kyathadevarayana Gudi,<br>
                                    Chamarajnagar,Around Mysore - 571 313<br>
                                    Karnataka, India.
                                </h6>
                            </div>
                        </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">7380.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">8680.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Suite Room [Maharaja Package]</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">6320.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">7435.00</p>
                        </div>
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Tented Cottage</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">6320.00</p>
                        </div>
                        ...
                        <div class="col-6" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">Standard Room [Biligiri Package]</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                    ...
                    <p class="mt-15"><strong>Package Includes:</strong> Stay, Buffect Lunch Dinner & Breakfast with Jeep safari into BRT Wildlife Sanctuary x 2, Forest Entry Fees & Campfire.</p>
                </div>
                <div class="col-xl-12">
                    <div class="tour-plan">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="event-details">
                                                Check in. Settle down & freshen up with welcome drink
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>1:30 pm - </strong></td>
                                            <td class="event-details">
                                                Treat yourself for a Buffet lunch at the Gol Ghar
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>3:45 pm - </strong></td>
                                            <td class="event-details">
                                ...
                                <table class="event-table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="event-details">
                                                Wake-up call & tea/coffee served in the Room
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>6:15 am - </strong></td>
                                            <td class="event-details">
                                                Our naturalists take you on a Jeep ride in to the BRT Wildlife Sanctuary showing & sharing their experiences and information about the jungle and all the animals that live there.t
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-clock" style="color: #63AB45;"></i> <strong>8:45 am - </strong></td>
                                            <td class="event-details">
                ...
                <div class="col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i> Perhaps the biggest attractions nearby is the 600 years old champaka tree, known as Dodda Sampige.</li>
                                    <li><i class="bi bi-check-lg"></i> If you are willing to drive a bit, the historic Srirangapatna is just about one and a half hours away.</li>
                                    <li><i class="bi bi-check-lg"></i> A two hour drive will take you to the renowned Mudumalai National Park.</li>
                                    <li><i class="bi bi-check-lg"></i> One cannot forget Mysore which is about one and a half hour drive from the resort.</li>
                                    <li><i class="bi bi-check-lg"></i> Yelandur is another option for sightseeing near the resort. It is situation just about 30 minutes away and is home to several historic sites taking you back to the 16th century.</li>
                                    <li><i class="bi bi-check-lg"></i> About an hour away from BR Hills is the well-known Gaganachukki and Barachukki Waterfalls in Shivanasamudra.</li>
                                    <li><i class="bi bi-check-lg"></i> You can also visit the scenic water reservoir at Gundal Dam about an hour and a half away from the resort.</li>
                                    <li><i class="bi bi-check-lg"></i> Maradi Gudda which is a great view point in Kollegal is about an hour away.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p>The camp easily accessible and is located at Kyathadevarayana Gudi within B.R Hills Sanctuary limits. It is just 86 km from Mysore (via Nanjangud and Chamrajnagar) and 225 km from Bangalore (via Kanakapura – Malavalli – Kollegal – B R Hills). K.Gudi Camp is about 175 km from Coimbatore in Tamil Nadu (via Sathyamangalam and Chamarajnagar).</p>
                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d997200.234411038!2d76.7480916042918!3d12.495373296922528!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e0!4m5!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBangalore%2C%20Karnataka!3m2!1d12.9715987!2d77.5945627!4m5!1s0x3baf2923aa0b2d53%3A0xa32f7350beb369ee!2sK%20Gudi%20Wilderness%20Camp%2C%20Punajur%20State%20Forest%2C%20Karnataka!3m2!1d11.902453999999999!2d77.122359!5e0!3m2!1sen!2sin!4v1585031821021!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
