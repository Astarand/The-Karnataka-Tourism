...
<head>
    ...
    <title>Galibore Nature Camp | Riverside Wilderness Retreat</title>
    <meta name="description" content="Relax by the riverside at Galibore Nature Camp. Enjoy serene wildlife, scenic trails, and cosy stays in the heart of Karnataka's lush wilderness.">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/eco-resorts/galibore-fishing-camp.php">
    ...
    <div class="package-details-area pt-80 mb-40 position-relative">
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    <img src="../assets/img/resorts/galibore-resort-1.jpg" alt="Karnataka Tourism">
                                    <a data-fancybox="gallery-01" href="../assets/img/resorts/galibore-resort-1.jpg"><i class="bi bi-eye"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-6 h-100">
                                <div class="row g-3 h-100">
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/galibore-resort-2.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/galibore-resort-2.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/galibore-resort-3.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/galibore-resort-3.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            <img src="../assets/img/resorts/galibore-resort-4.jpg" alt="Karnataka Tourism">
                                            <a data-fancybox="gallery-01" href="../assets/img/resorts/galibore-resort-4.jpg"><i class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap active">
                                            <img src="../assets/img/resorts/galibore-resort-5.jpg" alt="Karnataka Tourism">
            ...
            <div class="others-image-wrap d-none">
                <a href="../assets/img/resorts/galibore-resort-6.jpg" data-fancybox="images"><img src="../assets/img/resorts/galibore-resort-6.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/galibore-resort-7.jpg" data-fancybox="images"><img src="../assets/img/resorts/galibore-resort-7.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/galibore-resort-8.jpg" data-fancybox="images"><img src="../assets/img/resorts/galibore-resort-8.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/galibore-resort-9.jpg" data-fancybox="images"><img src="../assets/img/resorts/galibore-resort-9.jpg" alt="Karnataka Tourism"></a>
                <a href="../assets/img/resorts/galibore-resort-10.jpg" data-fancybox="images"><img src="../assets/img/resorts/galibore-resort-10.jpg" alt="Karnataka Tourism"></a>
            </div>
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    <h1 class="eco-head">Discover the Serenity of Galibore Nature Camp</h1>
                    ...
                    <h3 class="mb-2" style="color:#63ab45">Your Riverside Escape into Nature</h3>
                    <p>Escape to Galibore Nature Camp, where tranquillity meets adventure in a breathtaking wilderness setting. Nestled along the banks of the enchanting Cauvery River, this camp invites you to immerse yourself in the beauty of nature, surrounded by lush forests and vibrant wildlife. Whether you long for the soothing sounds of the river or the thrill of exploring nearby trails, Galibore Nature Camp is your ideal retreat from the everyday grind. Enjoy cosy yet straightforward accommodations that let you relax while remaining close to the stunning natural world.</p>
                    <h3 class="mb-2" style="color:#63ab45">Experience Adventure While Unwinding</h3>
                    <p>At Galibore Nature Camp, every day offers an exciting mix of adventure and serenity. Start your mornings with a peaceful nature walk, glide along the river on a coracle, or enjoy a leisurely day of fishing. As dusk falls, let the tranquil surroundings provide the perfect backdrop for relaxation and reflection. Whether you’re an adventure seeker or need peace, Galibore Nature Camp is your ultimate riverside getaway. Begin planning your refreshing escape to this idyllic retreat today!</p>
                ...
                <div class="col-xl-4">
                    <div class="contact-page">
                        ...
                        <div class="single-contact mb-40">
                            ...
                            <div class="content">
                                <h6>
                                    Uyamballi Post, Kanakapura Taluk,<br>
                                    Sangam, Bangalore District (Rural)<br>
                                    Around Bangalore- 562117<br>
                                    Karnataka, India.
                                </h6>
                            </div>
                        </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">4820.00</p>
                        </div>
                        <div class="col-3" style="border: 1px solid #ddd">
                            <p class="py-1 text-center">5620.00</p>
                        </div>
                    </div>
                    <p class="mt-15"><strong>Package Includes:</strong> Stay, Buffect Lunch, Dinner & Breakfast with Coracle Ride, Guided Trekking, Forest Entry Fees & Campfire.</p>
                </div>
                <div class="col-xl-12">
                    <div class="tour-plan">
                ...
                <div class="col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="includ-and-exclud-area mb-20">
                                <ul>
                                    <li><i class="bi bi-check-lg"></i> Just 28 kilometers from Galibore is Bheemeshwari, by the River Cauvery. You will love the exhilarating water adventures the place offers.</li>
                                    <li><i class="bi bi-check-lg"></i> Sangam is a only 10 kilometers from the resort. This is where rivers Arkavathi and Cauvery meet.</li>
                                    <li><i class="bi bi-check-lg"></i> Mekedatu is even closer at about 8 kilometers and is a very popular picnic spot amidst nature.</li>
                                    <li><i class="bi bi-check-lg"></i> Driving for about 2 hours to Gaganachukki and Barachukki falls is worth the effort. You wouldn’t have seen anything like this before.</li>
                                    <li><i class="bi bi-check-lg"></i> A little over 2-hour drive will take you to the famous Bannerghatta National Park.</li>
                                    ...
                                    <li><i class="bi bi-check-lg"></i> For bird lovers Kokrebellur Pelicanry near Bheemeshwari is a must visit.</li>
                                    <li><i class="bi bi-check-lg"></i> Chunchi Water Falls is about 21 kilometers away from the resort as you drive in the direction of Sangam.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="tour-location">
                                <h4>How To Reach</h4>
                                <p>Exactly hundred kilometres from Bangalore, a signpost at Kanakapura guides you to turn left into a village road that'll take you to Sangam, the confluence of the two rivers Arkavathi and Cauvery. From here, following another signpost, it's a short drive of about ten kilometres on a gravelly track, through a wooded terrain, to the Camp. Though it is an unmetalled road, we have ensured that cars can reach Galibore. By the way, this place is 6km down stream of Muttatti village.</p>
                                <div class="map-area mb-30">
                                    <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3898.4818955261608!2d77.3719356747493!3d12.283300487972419!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3baee57f6b8c0a29%3A0xa3fd9b502e4ee6d1!2sGalibore%20Nature%20Camp%20-%20Junglelodges%20and%20Resorts!5e0!3m2!1sen!2sin!4v1690295291884!5m2!1sen!2sin" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
