...
<head>
    ...
    <title>Contact Us | Karnataka Tourism - Easy Travel Assistance</title>
    <meta name="description" content="Contact us today for travel support. Reach out for quick answers, booking help, or general enquiries. We're here to assist with your journey.">
    <meta name="geo.region" content="IN">
    <link rel="canonical" href="https://www.thekarnatakatourism.com/contact.php">
...
<body>
    ...
    <div class="contact-page pt-120 mb-40">
        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-inner d-flex justify-content-center">
                                        <button class="primary-btn1 btn-hover" type="submit" style="padding:28px 90px">
                                            Submit Now
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="single-contact mb-40">
                        ...
                        <div class="content">
                            <h6>
                                ...
                                Chikkalasandra Post,Bangalore – 560061,<br>
                                Karnataka, India.
                            </h6>
                        </div>
                    </div>
    ...
    <!-- <div class="contact-map">
        <iframe width="100%" height="50" frameborder="0" style="border:0" src="https://www.google.com/maps?q=Dandeli.Com - The Official Travel Partners&output=embed" allowfullscreen></iframe>
    </div> -->
