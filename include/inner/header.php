<header class="header-area style-1">
    <div class="header-logo">
        <a href="../index.php"><img alt="image" class="img-fluid" src="../assets/img/logo/logo.webp"></a>
    </div>
    <div class="main-menu enable-scroll">
        <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap">
                <a href="../index.php"><img alt="image" src="../assets/img/logo/logo.webp"></a>
            </div>
        ...
        <ul class="menu-list">
            ...
            <li><a href="../about.php" class="drop-down">About us</a></li>
            <li class="menu-item-has-children mega-menu">
                <a href="#" class="drop-down">Eco Resorts</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
                    <li><a href="../eco-resorts/bandipur-safari-lodge.php">Bandipur Safari Lodge</a></li>
                    <li><a href="../eco-resorts/kabini-river-lodge.php">Kabini River Lodge</a></li>
                    <li><a href="../eco-resorts/k-gudi-wilderness-camp.php">K Gudi Wilderness Camp</a></li>
                    <li><a href="../eco-resorts/old-magazine-house.php">Old Magazine House</a></li>
                    <li><a href="../eco-resorts/kali-adventure-camp.php">Kali Adventure Camp</a></li>
                    <li><a href="../eco-resorts/river-tern-lodge.php">River Tern Lodge</a></li>
                    <li><a href="../eco-resorts/galibore-fishing-camp.php">Galibore Nature Camp</a></li>
                    <li><a href="../eco-resorts/devbagh-beach-resort.php">Devbagh Beach Resort</a></li>
                    <li><a href="../eco-resorts/om-beach-resort.php">Om Beach Resort</a></li>
                    <li><a href="../eco-resorts/dubare-elephant-camp.php">Dubare Elephant Camp</a></li>
                    <li><a href="../eco-resorts/hampi-heritage-wilderness-resort.php">Hampi Heritage & Wilderness Resort</a></li>
                    <li><a href="../eco-resorts/sharavati-adventure-camp.php">Sharavati Adventure Camp</a></li>
                    <li><a href="../eco-resorts/kings-sanctuary-nagarhole.php">Kings Sanctuary Resort</a></li>
                    <li><a href="../eco-resorts/bheemeshwari-fishing-camp.php">Bheemeshwari Adventure Camp</a></li>
                    <li><a href="../eco-resorts/bannerghatta-nature-camp.php">Bannerghatta Nature Camp</a></li>
                </ul>
            </li>
            <li class="menu-item-has-children">
                <a href="#" class="drop-down">Theme Holidays</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
                    <li><a href="../theme/wildlife-tours.php">Wildlife Tours</a></li>
                    <li><a href="../theme/nature-tours.php">Nature Tours</a></li>
                    <li><a href="../theme/adventure-tours.php">Adventure Tours</a></li>
                    <li><a href="../theme/beach-tours.php">Beach Tours</a></li>
            ...
            <a href="../book.php" class="primary-btn1 d-lg-none d-flex justify-content-center">PLAN MY TRIP</a>
        </ul>
    ...
    <div class="nav-right d-flex justify-content-end align-items-center">
        <a href="../book.php" class="primary-btn3 d-xl-flex d-none">PLAN MY TRIP</a>
        <ul class="icon-list">
